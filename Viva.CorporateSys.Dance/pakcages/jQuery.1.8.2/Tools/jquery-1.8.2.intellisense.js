...
intellisense.annotate(jQuery, {
  'ajax': function() {
    ...
    ///   <param name="settings" type="Object">A set of key/value pairs that configure the Ajax request. All settings are Assignmental. A default can be set for any Assignment with $.ajaxSetup(). See jQuery.ajax( settings ) below for a complete list of all settings.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
    /// <signature>
    ///   <summary>Perform an asynchronous HTTP (Ajax) request.</summary>
    ///   <param name="settings" type="Object">A set of key/value pairs that configure the Ajax request. All settings are Assignmental. A default can be set for any Assignment with $.ajaxSetup().</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'ajaxPrefilter': function() {
    /// <signature>
    ///   <summary>Handle custom Ajax Assignments or modify existing Assignments before each request is sent and before they are processed by $.ajax().</summary>
    ///   <param name="dataTypes" type="String">An Assignmental string containing one or more space-separated dataTypes</param>
    ///   <param name="handler(Assignments, originalAssignments, jqXHR)" type="Function">A handler to set default values for future Ajax requests.</param>
    /// </signature>
  },
  'ajaxSetup': function() {
    /// <signature>
    ///   <summary>Set default values for future Ajax requests.</summary>
    ///   <param name="Assignments" type="Object">A set of key/value pairs that configure the default Ajax request. All Assignments are Assignmental.</param>
    /// </signature>
  },
  'boxModel': function() {
  ...
  'Callbacks': function() {
    ...
    ///   <param name="flags" type="String">An Assignmental list of space-separated flags that change how the callback list behaves.</param>
    /// </signature>
  },
  'contains': function() {
    /// <signature>
...
intellisense.annotate(_object, {
  'always': function() {
    ...
    ///   <param name="alwaysCallbacks" type="Function">Assignmental additional functions, or arrays of functions, that are called when the Deferred is resolved or rejected.</param>
  ...
  'done': function() {
    ...
    ///   <param name="doneCallbacks" type="Function">Assignmental additional functions, or arrays of functions, that are called when the Deferred is resolved.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'fail': function() {
    ...
    ///   <param name="failCallbacks" type="Function">Assignmental additional functions, or arrays of functions, that are called when the Deferred is rejected.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'isRejected': function() {
  ...
  'notify': function() {
    ...
    ///   <param name="args" type="Object">Assignmental arguments that are passed to the progressCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'notifyWith': function() {
  ...
  'pipe': function() {
    ...
    ///   <param name="doneFilter" type="Function">An Assignmental function that is called when the Deferred is resolved.</param>
    ///   <param name="failFilter" type="Function">An Assignmental function that is called when the Deferred is rejected.</param>
    ///   <returns type="Promise" />
    /// </signature>
    /// <signature>
    ///   <summary>Utility method to filter and/or chain Deferreds.</summary>
    ///   <param name="doneFilter" type="Function">An Assignmental function that is called when the Deferred is resolved.</param>
    ///   <param name="failFilter" type="Function">An Assignmental function that is called when the Deferred is rejected.</param>
    ///   <param name="progressFilter" type="Function">An Assignmental function that is called when progress notifications are sent to the Deferred.</param>
    ///   <returns type="Promise" />
    /// </signature>
  },
  'progress': function() {
  ...
  'reject': function() {
    ...
    ///   <param name="args" type="Object">Assignmental arguments that are passed to the failCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'rejectWith': function() {
    ...
    ///   <param name="args" type="Array">An Assignmental array of arguments that are passed to the failCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'resolve': function() {
    ...
    ///   <param name="args" type="Object">Assignmental arguments that are passed to the doneCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'resolveWith': function() {
    ...
    ///   <param name="args" type="Array">An Assignmental array of arguments that are passed to the doneCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'state': function() {
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'data': function() {
    /// <summary>An Assignmental data map passed to an event method when the current executing handler is bound.</summary>
  },
...
intellisense.annotate(jQuery.fn, {
  ...
  'ajaxComplete': function() {
    ...
    ///   <param name="handler(event, XMLHttpRequest, ajaxAssignments)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxError': function() {
  ...
  'ajaxSend': function() {
    ...
    ///   <param name="handler(event, jqXHR, ajaxAssignments)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxStart': function() {
  ...
  'animate': function() {
    ...
    ///   <summary>Perform a custom animation of a set of CSS properties.</summary>
    ///   <param name="properties" type="Object">A map of CSS properties that the animation will move toward.</param>
    ///   <param name="Assignments" type="Object">A map of additional Assignments to pass to the method. Supported keys:         duration: A string or number determining how long the animation will run.easing: A string indicating which easing function to use for the transition.complete: A function to call once the animation is complete.step: A function to be called after each step of the animation.queue: A Boolean indicating whether to place the animation in the effects queue. If false, the animation will begin immediately. As of jQuery 1.7, the queue Assignment can also accept a string, in which case the animation is added to the queue represented by that string.specialEasing: A map of one or more of the CSS properties defined by the properties argument and their corresponding easing functions (added 1.4).</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'animated': function() {
  ...
  'children': function() {
    /// <signature>
    ///   <summary>Get the children of each element in the set of matched elements, Assignmentally filtered by a selector.</summary>
  ...
  'height': function() {
    ...
    ///   <param name="value" type="Number">An integer representing the number of pixels, or an integer with an Assignmental unit of measure appended (as a string).</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the CSS height of every matched element.</summary>
  ...
  'nextAll': function() {
    /// <signature>
    ///   <summary>Get all following siblings of each element in the set of matched elements, Assignmentally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'off': function() {
    ...
    ///   <param name="events" type="String">One or more space-separated event types and Assignmental namespaces, or just namespaces, such as "click", "keydown.myPlugin", or ".myPlugin".</param>
    ...
    /// <signature>
    ///   <summary>Remove an event handler.</summary>
    ///   <param name="events-map" type="Object">A map where the string keys represent one or more space-separated event types and Assignmental namespaces, and the values represent handler functions previously attached for the event(s).</param>
    ///   <param name="selector" type="String">A selector which should match the one originally passed to .on() when attaching event handlers.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'on': function() {
    ...
    ///   <param name="events" type="String">One or more space-separated event types and Assignmental namespaces, such as "click" or "keydown.myPlugin".</param>
    ...
    /// <signature>
    ///   <summary>Attach an event handler function for one or more events to the selected elements.</summary>
    ///   <param name="events-map" type="Object">A map in which the string keys represent one or more space-separated event types and Assignmental namespaces, and the values represent a handler function to be called for the event(s).</param>
  ...
  'outerHeight': function() {
    /// <signature>
    ///   <summary>Get the current computed height for the first element in the set of matched elements, including padding, border, and Assignmentally margin. Returns an integer (without "px") representation of the value or null if called on an empty set of elements.</summary>
  ...
  'parent': function() {
    /// <signature>
    ///   <summary>Get the parent of each element in the current set of matched elements, Assignmentally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'parents': function() {
    /// <signature>
    ///   <summary>Get the ancestors of each element in the current set of matched elements, Assignmentally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'prev': function() {
    /// <signature>
    ///   <summary>Get the immediately preceding sibling of each element in the set of matched elements, Assignmentally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'prevAll': function() {
    /// <signature>
    ///   <summary>Get all preceding siblings of each element in the set of matched elements, Assignmentally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'siblings': function() {
    /// <signature>
    ///   <summary>Get the siblings of each element in the set of matched elements, Assignmentally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'width': function() {
    ...
    ///   <param name="value" type="Number">An integer representing the number of pixels, or an integer along with an Assignmental unit of measure appended (as a string).</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the CSS width of each element in the set of matched elements.</summary>
